...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {
      name: 'condition',
      symbols: ['condition', '_', 'logical_operator', '_', 'not_operation'],
    ...
    {
      name: 'logical_operator$subexpression$1',
      symbols: [/[aA]/, /[nN]/, /[dD]/],
      postprocess: function (d) {
        return d.join('');
      }
    },
    {
      ...
      symbols: ['logical_operator$subexpression$1'],
      postprocess: operator('and')
    },
    {
      name: 'logical_operator$subexpression$2',
      symbols: [/[oO]/, /[rR]/],
      postprocess: function (d) {
        return d.join('');
      }
    ...
    {
      name: 'logical_operator',
      symbols: ['logical_operator$subexpression$2'],
      postprocess: operator('or')
    },
    {
      name: 'not_operation',
      symbols: ['not_operator', '_', 'comparison'],
    ...
    {
      name: 'not_operator$subexpression$1',
      symbols: [/[nN]/, /[oO]/, /[tT]/],
      postprocess: function (d) {
        return d.join('');
      }
    ...
    {
      name: 'not_operator',
      symbols: ['not_operator$subexpression$1'],
      postprocess: operator('not')
    },
    {
      name: 'comparison',
    ...
    {
      name: 'comparison',
      symbols: [{ literal: '(' }, '_', 'condition', '_', { literal: ')' }],
      postprocess: nth(2)
    },
    {
      name: 'comparison_operator',
      symbols: [{ literal: '=' }],
      postprocess: operator('eq')
    },
    {
      name: 'comparison_operator$string$1',
      symbols: [{ literal: '!' }, { literal: '=' }],
      postprocess: (d) => d.join('')
    },
    {
      name: 'comparison_operator',
      symbols: ['comparison_operator$string$1'],
      postprocess: operator('neq')
    },
    {
      name: 'comparison_operator',
      symbols: [{ literal: '<' }],
      postprocess: operator('lt')
    },
    {
      name: 'comparison_operator$string$2',
      symbols: [{ literal: '<' }, { literal: '=' }],
      postprocess: (d) => d.join('')
    },
    {
      name: 'comparison_operator',
      symbols: ['comparison_operator$string$2'],
      postprocess: operator('lte')
    },
    {
      name: 'comparison_operator',
      symbols: [{ literal: '>' }],
      postprocess: operator('gt')
    },
    {
      name: 'comparison_operator$string$3',
      symbols: [{ literal: '>' }, { literal: '=' }],
      postprocess: (d) => d.join('')
    },
    {
      name: 'comparison_operator',
      symbols: ['comparison_operator$string$3'],
      postprocess: operator('gte')
    },
    {
      name: 'comparison_operator',
      symbols: [{ literal: '~' }],
    ...
    {
      name: 'selector',
      symbols: ['identifier', { literal: '.' }, 'selector'],
      postprocess: join
    },
    ...
    {
      name: 'number',
      symbols: ['number$ebnf$1', 'number$ebnf$2'],
      postprocess: integer
    },
    ...
    {
      name: 'number$ebnf$4',
      symbols: ['number$ebnf$4', /[0-9]/],
      postprocess: (d) => d[0].concat([d[1]])
    },
    { name: 'number$ebnf$5', symbols: [/[0-9]/] },
    {
      name: 'number$ebnf$5',
      symbols: ['number$ebnf$5', /[0-9]/],
      postprocess: (d) => d[0].concat([d[1]])
    },
    {
      name: 'number',
