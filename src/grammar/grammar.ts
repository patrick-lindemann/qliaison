...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {'name': 'condition', 'symbols': ['condition', '__', 'logical_operator', '__', 'comparison'], 'postprocess': binaryOperation},
    {'name': 'condition', 'symbols': ['not_operator', '__', 'condition'], 'postprocess': unaryOperation},
